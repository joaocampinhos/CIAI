...
public interface BookingRepository extends CrudRepository<Booking, Long> {
  ...
  @Query("SELECT b FROM Booking b join b.hotel where h = :hotel AND b.roomType = :roomtype AND ((:arrival <= b.arrival AND b.arrival <= :departure) OR (:arrival <= b.departure AND b.departure <= :departure))")
